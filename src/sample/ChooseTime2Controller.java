...
public class ChooseTime2Controller {
    @FXML
    ...
    @FXML public void initialize(){
        ps_img.setStyle("-fx-image: url('/img/toy.jpg')");
        ...
        des_txt.setText("Nine years earlier,\n between the events of \nToy Story 2 and 3, Bo Peep and \nWoody are trying to rescue RC,\n Andy's remote controlled car.\n Just as they finish the rescue,\n Bo is donated to a new owner.\n Woody considers going with her,\n a teenage Andy donates them to Bonnie");
        try {
            mediaPlayer = new MediaPlayer(new Media(getClass().getResource("/trailer/toy.mp4").toURI().toString()));
    ...
    @FXML public void handleGoBtn_t_1OnAction(ActionEvent event) throws IOException {
        ...
        t1.setAll("chooseTime2.fxml","ToyStory",round,username);
        tl_media.getMediaPlayer().stop();
        a.show();
    ...
    @FXML public void handleGoBtn_t_2OnAction(ActionEvent event) throws IOException {
        ...
        String round = b.getText();
        t2.setAll("chooseTime2.fxml","ToyStory",round,username);
        tl_media.getMediaPlayer().stop();
        a.show();
    ...
    @FXML public void handleGoBtn_t_3OnAction(ActionEvent event) throws IOException {
        ...
        String round = b.getText();
        t3.setAll("chooseTime2.fxml","ToyStory",round,username);
        tl_media.getMediaPlayer().stop();
        a.show();
    ...
    @FXML public void handleGoBtn_t_4OnAction(ActionEvent event) throws IOException {
        ...
        String round = b.getText();
        t4.setAll("chooseTime2.fxml","ToyStory",round,username);
        tl_media.getMediaPlayer().stop();
        a.show();
