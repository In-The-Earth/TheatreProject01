...
public class ChooseTime3Controller {
    @FXML
    ...
    @FXML public void initialize(){
        ps_img.setStyle("-fx-image: url('/img/lionking.jpg')");
        ...
        des_txt.setText("In the Pride Lands of Africa, \na pride of lions rule over\n the animal kingdom from Pride Rock. \nKing Mufasa's and Queen Sarabi's\n newborn son, Simba, is presented \nto the gathering animals by Rafiki\n the mandrill, the kingdom's shaman and \nadvisor. Mufasa shows Simba the \nPride Lands and explains to \nhim the responsibilities of kingship \nand the \"circle of life\"");
        try {
            mediaPlayer = new MediaPlayer(new Media(getClass().getResource("/trailer/lionking.mp4").toURI().toString()));
    ...
    @FXML public void handleGoBtn_t_1OnAction(ActionEvent event) throws IOException {
        ...
        t1.setAll("chooseTime3.fxml","LionKing",round,username);
        tl_media.getMediaPlayer().stop();
        a.show();
    ...
    @FXML public void handleGoBtn_t_2OnAction(ActionEvent event) throws IOException {
        ...
        String round = b.getText();
        t2.setAll("chooseTime3.fxml","LionKing",round,username);
        tl_media.getMediaPlayer().stop();
        a.show();
    ...
    @FXML public void handleGoBtn_t_3OnAction(ActionEvent event) throws IOException {
        ...
        String round = b.getText();
        t3.setAll("chooseTime3.fxml","LionKing",round,username);
        tl_media.getMediaPlayer().stop();
        a.show();
    ...
    @FXML public void handleGoBtn_t_4OnAction(ActionEvent event) throws IOException {
        ...
        String round = b.getText();
        t4.setAll("chooseTime3.fxml","LionKing",round,username);
        tl_media.getMediaPlayer().stop();
        a.show();
