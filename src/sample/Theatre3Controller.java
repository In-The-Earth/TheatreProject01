...
public class Theatre3Controller {
    private int money =0;
    private String username;
    private String movie;
    private String comingfrom;
    private String round;
    private String theatre = "t3";
    ...
    @FXML public void handleGoBuy_btnOnAction(ActionEvent event) throws IOException {
        ...
        c.setAll(username,"theatre 3",movie,round,arrayChairs,"theatre3.fxml",comingfrom,String.valueOf(money),ticketsCheck);
        a.show();
