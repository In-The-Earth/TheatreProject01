...
public class Theatre4Controller {
    private int money =0;
    private String username;
    private String movie;
    private String comingfrom;
    private String round;
    private String theatre = "t4";
    ...
    @FXML
    Button A1,A2,A3,A4,A5,A6,A7,A8,A9,A10,B1,B2,B3,B4,B5,B6,B7,B8,B9,B10,C1,C2,C3,C4,C5,C6,C7,C8,C9,C10,D1,D2,D3,D4,D5,D6,D7,D8,D9,D10,E1,E2,E3,E4,E5,E6,E7,E8,E9,E10,V1,V2,V3,V4,V5,V6,V7,V8;
    ...
    @FXML public void initialize() {
        Platform.runLater(new Runnable() {
            ...
            public void run() {
                ...
                Button[] btns = {A1,A2,A3,A4,A5,A6,A7,A8,A9,A10,B1,B2,B3,B4,B5,B6,B7,B8,B9,B10,C1,C2,C3,C4,C5,C6,C7,C8,C9,C10,D1,D2,D3,D4,D5,D6,D7,D8,D9,D10,E1,E2,E3,E4,E5,E6,E7,E8,E9,E10,V1,V2,V3,V4,V5,V6,V7,V8};
                if(checkTicket() == false){
                    for(int i=0; i<58;i++){
                        if( (btns[i].getId().charAt(0)) == 'V' ){
                            btns[i].setStyle("-fx-background-image: url('/img/chairb.png')");
                        }else {
        ...
        cb.setStyle("-fx-image: url('/img/chairb.png')");
    ...
    @FXML public void handleSelectOnAction(ActionEvent event) throws IOException {
        ...
        else if(b.getStyle() == "-fx-background-image: url('/img/chairb.png')"){
            b.setStyle("-fx-background-image: url('/img/chairbcheck.png')");
            ticketsCheck.add(username+","+theatre+","+round+","+b.getId()+","+movie);
            arrayChairs.add(b.getId());
            money += 200;
            price_num.setText(String.valueOf(money));
        }
        else if(b.getStyle() == "-fx-background-image: url('/img/chairbcheck.png')"){
            b.setStyle("-fx-background-image: url('/img/chairb.png')");
            ticketsCheck.remove(username+","+theatre+","+round+","+b.getId()+","+movie);
            arrayChairs.remove(b.getId());
            money -= 200;
            price_num.setText(String.valueOf(money));
    ...
    @FXML public void handleGoBuy_btnOnAction(ActionEvent event) throws IOException {
        ...
        c.setAll(username,"theatre 4",movie,round,arrayChairs,"theatre4.fxml",comingfrom,String.valueOf(money),ticketsCheck);
        a.show();
